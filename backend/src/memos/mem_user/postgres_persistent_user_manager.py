"""Persistent user management system for MemOS with configuration storage using PostgreSQL.

This module extends the PostgreSQL UserManager to provide persistent storage
